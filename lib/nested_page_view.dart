...
class PrimaryPageControllerCoordinator extends InheritedWidget {

  final NestedPageViewCoordinator coordinator;

  PrimaryPageControllerCoordinator({@required this.coordinator,@required Widget child,Key key})
      :super(key:key,child:child);

  ///返回一个controller
  static NestedPageViewCoordinator of(BuildContext context) {
    final PrimaryPageControllerCoordinator result = context
        .dependOnInheritedWidgetOfExactType<PrimaryPageControllerCoordinator>();
    return result?.coordinator;
  }

  @override
  bool updateShouldNotify(PrimaryPageControllerCoordinator oldWidget) => coordinator != oldWidget.coordinator;

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<NestedPageViewCoordinator>('controller', coordinator,
...
class CustomPageController extends ScrollController {
  ...
  double get page {
    ...
    'CustomPageController.page cannot be accessed before a PageView is built with it.',
    );
    assert(
    positions.length == 1,
...
// to plumb in the factory for CustomPagePosition, but it will end up accumulating
...
/// [PageView] is first constructed, and the [CustomPageController.viewportFraction],
...
class _PageViewState extends State<NestedPageView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (primaryCoordinator != null){
      ...
      ///是最顶层pageView
      _controller = _coordinator.outController;
    }
    ...
    final ScrollPhysics physics = _ForceImplicitScrollPhysics(
      allowImplicitScrolling: widget.allowImplicitScrolling,
        ...
        : widget.physics);
    return PrimaryPageControllerCoordinator(
      coordinator: primaryCoordinator??_coordinator,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<CustomPageController>('currentController', _controller, showName: false));
